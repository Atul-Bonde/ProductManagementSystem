...
<h2 align="center">Delete Product Details</h2>
<br>

<div align="center">
	<form action="/deleteproduct">

		<label for="id" style="color: black"> <b>Product Id</b></label> <input
			type="text" name="id" placeholder="Enter Product Name" required><br>
		<br>
